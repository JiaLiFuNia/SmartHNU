package com.smart.miuiStrongToast
...
class StrongToastBundle private constructor() {
    ...
    class Builder {
        ...
        fun setStrongToastCategory(strongToastCategory: String) =
            apply { this.strongToastCategory = strongToastCategory }
        ...
        fun setStrongToastChargeFlag(strongToastChargeFlag: Int) =
            apply { this.strongToastChargeFlag = strongToastChargeFlag }

        fun setStatusBarStrongToast(statusBarStrongToast: String?) =
            apply { this.statusBarStrongToast = statusBarStrongToast }
