...
import com.smart.htu.component.chart.BasicPieChart
                    ...
                    item {
                        Card {
                            ...
                            Box(
                                ...
                                if (!uiState.windowConsumptionData.isNullOrEmpty()) {
                                    BasicPieChart(
                                        data = uiState.windowConsumptionData!!.values.map { it.toDouble() },
                                        labels = uiState.windowConsumptionData!!.keys.toList(),
