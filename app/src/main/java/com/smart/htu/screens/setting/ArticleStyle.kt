...
import com.smart.htu.screens.news.newsView.NewsStyle.fontMap
                                ...
                                webViewState = rememberWebViewStateWithHTMLData(
                                    data = NewsHTML.HTML.format(
                                        NewsStyle.get(
                                            ...
                                            fontFamily = fontMap[uiState.newsFontFamilyIndex],
                                            lineHeight = 1.0F,
                                            letterSpacing = 0.5F,
                                            textMargin = HORIZONTAL_MARGIN,
                                            textColor = MiuixTheme.colorScheme.onBackground.copy(
                                                0.8f
                                            )
                                                .toArgb(),
                                            textBold = false,
                                            ...
                                            codeBgColor = MiuixTheme.colorScheme.onBackground.copy(
                                                0.8f
                                            )
                                                .toArgb(),
                                            tableMargin = 0,
                ...
                item {
                    Card {
                        OverlayDropdownPreference(
                            ...
                            summary = "更改字体样式",
                            items = fontList,
                            selectedIndex = uiState.newsFontFamilyIndex,
                            onSelectedIndexChange = { mode ->
                                viewModel.changeNewsFontFamily(mode)
                            }
                        )
                    }
                }
