...
sealed interface Route : NavKey {
    ...
    @Serializable
    data object AirConditionHistory : Route
    ...
    @Serializable
    data class CourseInfo(val courseTaskCode: String, val termCode: String) : Route
    ...
    @Serializable
    data object PhysicalTest : Route

    @Serializable
    data class AddPhysicalTestScore(val grade: Int? = null) : Route

    @Serializable
    data object MIStepTool: Route
}
