...
object ParseNewsListUtil {

    private val PARSE_RULE = NewsListParseRule(
    ...
    private val NOTICE_PARSE_RULE = NewsListParseRule(
        SingleParseRule("all", "ul.list2 li.news", ""),
    ...
    private val MATH_PARSE_RULE = NewsListParseRule(
    ...
    private val TEACHING_PARSE_RULE = NewsListParseRule(
        SingleParseRule("all", "ul.news_list li.news", ""),
    ...
    private val SEARCH_PARSE_RULE = NewsListParseRule(
