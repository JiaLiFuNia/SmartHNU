    ...
    companion object {
        ...
        val ALL_APP_LIST = listOf(
            ApplicationEntity(
                ...
                outlinedIcon = R.drawable.water_ec,
                icon = R.drawable.water_ec_filled,
            ...
            ApplicationEntity(
                ...
                outlinedIcon = R.drawable.apartment,
                icon = R.drawable.apartment_filled,
            ...
            ApplicationEntity(
                ...
                outlinedIcon = R.drawable.book_4,
                icon = R.drawable.book_4_filled,
            ...
            ApplicationEntity(
                guestMode = false,
                loginMode = LoginMode.COMMON,
                outlinedIcon = R.drawable.finance,
                icon = R.drawable.finance_filled,
            ...
            ApplicationEntity(
                guestMode = true,
                outlinedIcon = R.drawable.near_me,
                icon = R.drawable.near_me_filled,
                iconColor = ApplicationEntity.ApplicationColor.GREEN,
            ...
            ApplicationEntity(
                ...
                outlinedIcon = R.drawable.format_paint,
                icon = R.drawable.format_paint_filled,
                iconColor = ApplicationEntity.ApplicationColor.ORANGE,
            ...
            ApplicationEntity(
                guestMode = false,
                loginMode = LoginMode.COMMON,
                outlinedIcon = R.drawable.person_check,
                icon = R.drawable.person_check_filled,
                iconColor = ApplicationEntity.ApplicationColor.ORANGE,
            ...
            ApplicationEntity(
                guestMode = false,
                loginMode = LoginMode.AUTH_SERVER,
                outlinedIcon = R.drawable.credit_card,
            ...
            ApplicationEntity(
                ...
                guestMode = false,
                loginMode = LoginMode.COMMON,
                outlinedIcon = R.drawable.add_task,
                icon = R.drawable.add_task_filled,
                iconColor = ApplicationEntity.ApplicationColor.BLUE,
            ...
            ApplicationEntity(
                guestMode = false,
                loginMode = LoginMode.AUTH_SERVER,
                outlinedIcon = R.drawable.school,
                icon = R.drawable.school_filled,
                iconColor = ApplicationEntity.ApplicationColor.BLUE,
            ...
            ApplicationEntity(
                guestMode = false,
                loginMode = LoginMode.AUTH_SERVER,
                outlinedIcon = R.drawable.id_card,
                icon = R.drawable.id_card_filled,
                iconColor = ApplicationEntity.ApplicationColor.GREEN,
            ...
            ApplicationEntity(
                guestMode = false,
                loginMode = LoginMode.AUTH_SERVER,
                outlinedIcon = R.drawable.psychology_alt,
                icon = R.drawable.psychology_alt_filled,
                iconColor = ApplicationEntity.ApplicationColor.PURPLE,
            ...
            ApplicationEntity(
                guestMode = false,
                loginMode = LoginMode.AUTH_SERVER,
                outlinedIcon = R.drawable.captive_portal,
                icon = R.drawable.captive_portal_filled,
                iconColor = ApplicationEntity.ApplicationColor.PURPLE,
            ...
            ApplicationEntity(
                guestMode = false,
                loginMode = LoginMode.COMMON,
                outlinedIcon = R.drawable.calendar_month,
                icon = R.drawable.calendar_month_filled,
                iconColor = ApplicationEntity.ApplicationColor.BLUE,
            ...
            ApplicationEntity(
                guestMode = true,
                outlinedIcon = R.drawable.globe_book,
                icon = R.drawable.globe_book_filled,
            ...
            ApplicationEntity(
                guestMode = false,
                loginMode = LoginMode.COMMON,
                outlinedIcon = R.drawable.speaker_notes,
                icon = R.drawable.speaker_notes_filled,
                iconColor = ApplicationEntity.ApplicationColor.PURPLE,
            ...
            ApplicationEntity(
                enabled = true,
                guestMode = false,
                outlinedIcon = R.drawable.lab_profile,
                icon = R.drawable.lab_profile_filled,
                iconColor = ApplicationEntity.ApplicationColor.BLUE,
            ...
            ApplicationEntity(
                guestMode = false,
                loginMode = LoginMode.AUTH_SERVER,
                outlinedIcon = R.drawable.construction,
                icon = R.drawable.construction_filled,
                iconColor = ApplicationEntity.ApplicationColor.GRAY,
            ...
            ApplicationEntity(
                guestMode = false,
                loginMode = LoginMode.COMMON,
                outlinedIcon = R.drawable.quick_reference_all,
                icon = R.drawable.quick_reference_all_filled,
                iconColor = ApplicationEntity.ApplicationColor.PURPLE,
            ...
            ApplicationEntity(
                ...
                outlinedIcon = R.drawable.sports_handball,
                icon = R.drawable.sports_handball_filled,
                iconColor = ApplicationEntity.ApplicationColor.YELLOW,
