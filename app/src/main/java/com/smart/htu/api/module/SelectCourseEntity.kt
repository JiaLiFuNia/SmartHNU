...
data class CourseTypeInfoRes(
    ...
    data class CourseTypeInfoData(
        ...
        @SerializedName("qssj") val startTime0: String,
        @SerializedName("jssj") val endTime0: String,
        ...
        val startTime: String
            get() = when {
                startTime1.isNotEmpty() -> startTime1
                startTime2.isNotEmpty() -> startTime2
                startTime3.isNotEmpty() -> startTime3
                startTime4.isNotEmpty() -> startTime4
                else -> startTime0
            }

        val endTime: String
            get() = when {
                endTime1.isNotEmpty() -> endTime1
                endTime2.isNotEmpty() -> endTime2
                endTime3.isNotEmpty() -> endTime3
                endTime4.isNotEmpty() -> endTime4
                else -> endTime0
            }
    }
}
