...
public val WeatherIcon.`_351-fill`: ImageVector
    get() {
        if (`__351-fill` != null) {
            return `__351-fill`!!
        }
        `__351-fill` = Builder(name = "_351-fill", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
...
private var `__351-fill`: ImageVector? = null
