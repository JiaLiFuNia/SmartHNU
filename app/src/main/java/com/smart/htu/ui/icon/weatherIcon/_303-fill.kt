...
public val WeatherIcon.`_303-fill`: ImageVector
    get() {
        if (`__303-fill` != null) {
            return `__303-fill`!!
        }
        `__303-fill` = Builder(name = "_303-fill", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
...
private var `__303-fill`: ImageVector? = null
