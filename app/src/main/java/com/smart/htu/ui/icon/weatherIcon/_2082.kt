...
public val WeatherIcon._2082: ImageVector
    get() {
        if (__2082 != null) {
            return __2082!!
        }
        __2082 = Builder(name = "_2082", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(15.4f, 4.5f)
                lineTo(10.6f, 4.5f)
                arcTo(0.6f, 0.6f, 0.0f, false, false, 10.0f, 5.1f)
                lineTo(10.0f, 5.1f)
                arcTo(0.6f, 0.6f, 0.0f, false, false, 10.6f, 5.7f)
                lineTo(15.4f, 5.7f)
                arcTo(0.6f, 0.6f, 0.0f, false, false, 16.0f, 5.1f)
                lineTo(16.0f, 5.1f)
                arcTo(0.6f, 0.6f, 0.0f, false, false, 15.4f, 4.5f)
                close()
            }
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
...
private var __2082: ImageVector? = null
