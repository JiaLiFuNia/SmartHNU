...
public val WeatherIcon.`_304-fill`: ImageVector
    get() {
        if (`__304-fill` != null) {
            return `__304-fill`!!
        }
        `__304-fill` = Builder(name = "_304-fill", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
...
private var `__304-fill`: ImageVector? = null
