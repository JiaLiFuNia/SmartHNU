...
public val WeatherIcon.`_400-fill`: ImageVector
    get() {
        if (`__400-fill` != null) {
            return `__400-fill`!!
        }
        `__400-fill` = Builder(name = "_400-fill", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
...
private var `__400-fill`: ImageVector? = null
