...
public val WeatherIcon.`_403-fill`: ImageVector
    get() {
        if (`__403-fill` != null) {
            return `__403-fill`!!
        }
        `__403-fill` = Builder(name = "_403-fill", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
...
private var `__403-fill`: ImageVector? = null
