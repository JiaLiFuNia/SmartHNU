...
public val WeatherIcon._2051: ImageVector
    get() {
        if (__2051 != null) {
            return __2051!!
        }
        __2051 = Builder(name = "_2051", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(2.11f, 1.421f)
                curveToRelative(-0.02f, -0.176f, 0.16f, -0.327f, 0.39f, -0.327f)
                reflectiveCurveToRelative(0.41f, 0.151f, 0.39f, 0.327f)
                lineTo(2.712f, 2.97f)
                horizontalLineToRelative(-0.426f)
                lineTo(2.11f, 1.42f)
                close()
                moveTo(2.815f, 3.594f)
...
private var __2051: ImageVector? = null
