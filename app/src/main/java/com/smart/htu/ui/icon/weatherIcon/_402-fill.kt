...
public val WeatherIcon.`_402-fill`: ImageVector
    get() {
        if (`__402-fill` != null) {
            return `__402-fill`!!
        }
        `__402-fill` = Builder(name = "_402-fill", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
...
private var `__402-fill`: ImageVector? = null
