...
public val WeatherIcon.`_456-fill`: ImageVector
    get() {
        if (`__456-fill` != null) {
            return `__456-fill`!!
        }
        `__456-fill` = Builder(name = "_456-fill", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
...
private var `__456-fill`: ImageVector? = null
