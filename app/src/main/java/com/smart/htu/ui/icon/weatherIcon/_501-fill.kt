...
public val WeatherIcon.`_501-fill`: ImageVector
    get() {
        if (`__501-fill` != null) {
            return `__501-fill`!!
        }
        `__501-fill` = Builder(name = "_501-fill", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
...
private var `__501-fill`: ImageVector? = null
