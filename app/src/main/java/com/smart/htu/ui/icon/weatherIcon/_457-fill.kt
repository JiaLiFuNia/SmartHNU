...
public val WeatherIcon.`_457-fill`: ImageVector
    get() {
        if (`__457-fill` != null) {
            return `__457-fill`!!
        }
        `__457-fill` = Builder(name = "_457-fill", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
...
private var `__457-fill`: ImageVector? = null
