...
public val WeatherIcon._514: ImageVector
    get() {
        if (__514 != null) {
            return __514!!
        }
        __514 = Builder(name = "_514", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    pathFillType = NonZero) {
                moveTo(9.0f, 0.121f)
                arcToRelative(4.997f, 4.997f, 0.0f, false, false, -5.35f, 2.243f)
                arcToRelative(0.334f, 0.334f, 0.0f, false, true, -0.32f, 0.154f)
                ...
                arcTo(3.0f, 3.0f, 0.0f, false, false, 15.959f, 6.0f)
                horizontalLineToRelative(-1.022f)
                arcToRelative(2.0f, 2.0f, 0.0f, false, true, -3.132f, 1.104f)
                ...
                arcTo(4.001f, 4.001f, 0.0f, false, true, 9.0f, 1.153f)
...
private var __514: ImageVector? = null
