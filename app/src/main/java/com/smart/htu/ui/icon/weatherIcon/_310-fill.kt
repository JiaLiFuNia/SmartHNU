...
public val WeatherIcon.`_310-fill`: ImageVector
    get() {
        if (`__310-fill` != null) {
            return `__310-fill`!!
        }
        `__310-fill` = Builder(name = "_310-fill", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
                viewportWidth = 16.0f, viewportHeight = 16.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(1.293f, 12.207f)
                arcTo(1.0f, 1.0f, 0.0f, false, true, 1.0f, 11.5f)
...
private var `__310-fill`: ImageVector? = null
