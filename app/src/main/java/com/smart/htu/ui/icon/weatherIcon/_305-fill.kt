...
public val WeatherIcon.`_305-fill`: ImageVector
    get() {
        if (`__305-fill` != null) {
            return `__305-fill`!!
        }
        `__305-fill` = Builder(name = "_305-fill", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
...
private var `__305-fill`: ImageVector? = null
