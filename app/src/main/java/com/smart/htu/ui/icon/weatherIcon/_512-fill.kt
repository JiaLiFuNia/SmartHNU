...
public val WeatherIcon.`_512-fill`: ImageVector
    get() {
        if (`__512-fill` != null) {
            return `__512-fill`!!
        }
        `__512-fill` = Builder(name = "_512-fill", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(9.031f, 2.958f)
                arcToRelative(1.0f, 1.0f, 0.0f, true, true, -2.0f, 0.0f)
                arcToRelative(1.0f, 1.0f, 0.0f, false, true, 2.0f, 0.0f)
                close()
                moveTo(8.031f, 13.98f)
...
private var `__512-fill`: ImageVector? = null
