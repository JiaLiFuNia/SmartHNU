...
public val WeatherIcon._2152: ImageVector
    get() {
        if (__2152 != null) {
            return __2152!!
        }
        __2152 = Builder(name = "_2152", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(0.703f, 0.703f, 0.0f, false, true, -0.497f, 0.497f)
                lineToRelative(-7.028f, 1.893f)
                arcToRelative(0.686f, 0.686f, 0.0f, false, true, -0.677f, -0.181f)
                lineToRelative(-5.14f, -5.154f)
...
private var __2152: ImageVector? = null
