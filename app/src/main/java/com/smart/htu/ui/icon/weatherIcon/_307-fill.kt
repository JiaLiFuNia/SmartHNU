...
public val WeatherIcon.`_307-fill`: ImageVector
    get() {
        if (`__307-fill` != null) {
            return `__307-fill`!!
        }
        `__307-fill` = Builder(name = "_307-fill", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
...
private var `__307-fill`: ImageVector? = null
