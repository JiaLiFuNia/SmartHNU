...
public val WeatherIcon._2208: ImageVector
    get() {
        if (__2208 != null) {
            return __2208!!
        }
        __2208 = Builder(name = "_2208", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(11.079f, 5.375f)
                arcTo(2.5f, 2.5f, 0.0f, false, true, 16.0f, 6.0f)
                ...
                close()
                moveTo(2.5f, 9.5f)
                arcTo(0.5f, 0.5f, 0.0f, false, true, 3.0f, 9.0f)
...
private var __2208: ImageVector? = null
