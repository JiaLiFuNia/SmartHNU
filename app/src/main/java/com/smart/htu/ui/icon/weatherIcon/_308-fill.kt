...
public val WeatherIcon.`_308-fill`: ImageVector
    get() {
        if (`__308-fill` != null) {
            return `__308-fill`!!
        }
        `__308-fill` = Builder(name = "_308-fill", defaultWidth = 16.0.dp, defaultHeight = 16.0.dp,
...
private var `__308-fill`: ImageVector? = null
